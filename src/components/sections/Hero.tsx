    ...
    <section className="relative min-h-[95vh] flex flex-col pt-24 overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-6 z-10 relative flex-grow flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-[55%] flex flex-col items-center lg:items-start justify-center text-center lg:text-left z-20 py-10 lg:py-24">
          ...
          <p className=" text-lg md:text-xl text-text-secondary font-medium tracking-tight max-w-lg mb-10">
        ...
        <div className="relative w-full lg:w-[45%] h-[55vh] lg:h-auto mt-auto lg:self-end flex items-end justify-center lg:justify-end z-10">
          ...
          <div className="relative w-full max-w-[350px] md:max-w-md lg:max-w-[450px] h-[100%] lg:h-[80vh] flex items-end">
            ...
            <div className="absolute bottom-0 left-0 w-full h-[85%] bg-gradient-to-t from-accent/10 to-transparent rounded-t-full border-t border-x border-accent/20 shadow-[0_0_50px_rgba(0,0,0,0.05)] -z-10 "></div>
            ...
            <div className="absolute top-[35%] md:top-[40%] lg:top-[30%] left-2 md:-left-4 lg:-left-12 bg-surface/90 backdrop-blur-md border border-border p-2 md:p-3 lg:p-4 rounded-2xl shadow-xl flex items-center space-x-2 md:space-x-3  z-20">
            ...
            <div className="absolute bottom-[20%] right-2 lg:-right-4 bg-surface/90 backdrop-blur-md border border-border p-3 lg:p-4 rounded-2xl shadow-xl flex items-center space-x-3  z-20">
