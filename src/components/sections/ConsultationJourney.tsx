...
export const ConsultationJourney = () => {
  const steps = [
    { title: "Reach Out", desc: "Send a direct message with your primary concern.", icon: <MessageCircle className="w-5 h-5 text-accent" /> },
    { title: "Get Guidance", desc: "Receive immediate consultation availability and next steps.", icon: <CalendarCheck className="w-5 h-5 text-accent" /> },
    { title: "Visit Clinic", desc: "Begin your personalized care journey with Dr. Shania.", icon: <MapPin className="w-5 h-5 text-accent" /> }
  ];
